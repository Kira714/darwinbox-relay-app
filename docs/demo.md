...
7. **Bring your own mock API.** `npm run mock:start`, choose *My mock API URL* = `http://127.0.0.1:4001/employees`, generate; `GET :4001/records` shows what it received.
8. **The dial.** In Settings drop the confidence bar to 70% and re-run: fewer questions. Raise it to 95%: more. *"This is where I drew the line, and it is a setting."*
